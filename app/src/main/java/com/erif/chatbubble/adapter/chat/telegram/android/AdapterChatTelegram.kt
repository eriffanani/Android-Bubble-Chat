package com.erif.chatbubble.adapter.chat.telegram.android
...
class AdapterChatTelegram(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return if (viewType == 1) {
            HolderOutgoing(inflater.inflate(
                    R.layout.item_chat_tele_outgoing, parent, false
            ))
        } else {
            HolderIncoming(inflater.inflate(
                    R.layout.item_chat_tele_incoming, parent, false
            ))
        }
    }
    ...
    inner class HolderIncoming(
        ...
        private val bubble: BubbleTelegram = itemView.findViewById(R.id.item_chat_tele_incoming_bubble)
        private val txt: TextView = itemView.findViewById(R.id.item_chat_tele_incoming_txt)
    ...
    inner class HolderOutgoing(
        ...
        private val bubble: BubbleTelegram = itemView.findViewById(R.id.item_chat_tele_outgoing_bubble)
        private val txt: TextView = itemView.findViewById(R.id.item_chat_tele_outgoing_txt)
