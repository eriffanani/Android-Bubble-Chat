package com.erif.chatbubble.adapter.chat.telegram.ios
...
import com.erif.bubble.telegram.BubbleTelegram
import com.erif.chatbubble.R
import com.erif.chatbubble.adapter.chat.ItemChat
import com.erif.chatbubble.adapter.chat.telegram.android.AdapterChatTelegram.HolderIncoming
import com.erif.chatbubble.adapter.chat.telegram.android.AdapterChatTelegram.HolderOutgoing

class AdapterChatTelegramIOS(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return if (viewType == 1) {
            HolderOutgoing(inflater.inflate(
                R.layout.item_chat_tele_ios_outgoing, parent, false
            ))
        } else {
            HolderIncoming(inflater.inflate(
                R.layout.item_chat_tele_ios_incoming, parent, false
            ))
        }
    }
    ...
    inner class HolderIncoming(
        ...
        private val bubble: BubbleTelegram = itemView.findViewById(R.id.item_chat_tele_ios_incoming_bubble)
        private val txt: TextView = itemView.findViewById(R.id.item_chat_tele_ios_incoming_txt)
    ...
    inner class HolderOutgoing(
        ...
        private val bubble: BubbleTelegram = itemView.findViewById(R.id.item_chat_tele_ios_outgoing_bubble)
        private val txt: TextView = itemView.findViewById(R.id.item_chat_tele_ios_outgoing_txt)
